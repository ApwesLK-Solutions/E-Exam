<?php
    ...
    if(isset($_POST['subject']) && isset($_POST['grade']) && isset($_POST['institute']) && isset($_POST['description']) && isset($_POST['ekey']) && isset($_POST['ekeyvisible']))
    {
        ...
        $ekey = $_POST['ekey'];
        $ekeyvisible = $_POST['ekeyvisisble'];
        $uid = $_SESSION['id'];
